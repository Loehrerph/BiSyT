...
excelsheet_names{1,2} = 'Right PFC to left lPM';  
excelsheet_names{1,3} = 'Right PFC to right lPM';
excelsheet_names{1,4} = 'Right PFC to SMA';

% cd to Figure Folder Philipps PC
cd('..\Grafiken\Figure_4\PFC_lPM');
